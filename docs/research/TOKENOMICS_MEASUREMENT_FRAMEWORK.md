...
## Research Paper — PARALLAX Tokenomics
...
$$
CRPT = \frac{Cognitive\ Return}{Prompt\ Tokens + Output\ Tokens}
$$
...
$$
CRPT = \frac{DQ + ACT + RISK + REUSE + LEARN}{TotalTokens}
$$
...
$$
B_i = B_{total} \cdot \frac{S_i}{\sum S}
$$
...
| $B_{total}$ | Total available output budget |
...
$$
CE = \frac{MeaningPreserved}{TokensUsed}
$$

A more operational version is:

$$
CEF = \frac{InformationRetained + ActionClarity + RiskPreserved}{OutputTokens}
$$
...
$$
TokenomicGain = \frac{Score_B}{Tokens_B} - \frac{Score_A}{Tokens_A}
$$
